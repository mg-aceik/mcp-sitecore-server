...
| Create or change a template | \`authoring-create-item-template\` / \`authoring-update-item-template\` | \`common-set-item-template\`, \`common-add-base-template\` | The authoring tools build a template with its sections and fields in one call. The SPE tools only assign a template or edit the base list. |
